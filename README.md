# Python_project
1.) This program outputs data into excel sheet based on the input kewords.

2.) On first prompt, it asks for any of the keywords "PS" or "NAME" or "EMAIL". 
...
Data Excel sheet is present in 3_Implementation/src
